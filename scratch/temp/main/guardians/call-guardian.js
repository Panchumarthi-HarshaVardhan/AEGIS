...
class CallGuardian extends base_guardian_1.BaseGuardian {
    ...
    initialize() {
        ...
        this.eventBus.subscribe('call:transcript', async (text) => {
            if (!this.active)
                return;
            try {
